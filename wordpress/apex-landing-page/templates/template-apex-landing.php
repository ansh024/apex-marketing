  ...
  <div class="container founder__grid">
    ...
    <div class="founder__copy">
      ...
      <div class="founder__stats">
        ...
        <div><span class="stat" data-prefix="$" data-count="0">$0</span><small>Upfront to start</small></div>
      </div>
...
<section class="proof" id="proof">
  <div class="container">
    ...
    <div class="proof__testimonials">
      <article class="tsm reveal"><div class="tsm__video" aria-hidden="true"><span class="tsm__play">▶</span><span class="tsm__badge">Video testimonial — coming soon</span></div><p>"Placeholder — real patient-growth story from a board-certified surgeon goes here."</p><footer>Board-certified plastic surgeon · Austin, TX</footer></article>
      <article class="tsm reveal"><div class="tsm__video" aria-hidden="true"><span class="tsm__play">▶</span><span class="tsm__badge">Video testimonial — coming soon</span></div><p>"Placeholder — real consult-volume result and agency-switch story goes here."</p><footer>Board-certified facial plastic surgeon · Chicago, IL</footer></article>
      <article class="tsm reveal"><div class="tsm__video" aria-hidden="true"><span class="tsm__play">▶</span><span class="tsm__badge">Video testimonial — coming soon</span></div><p>"Placeholder — real front-desk / coordinator experience quote goes here."</p><footer>Practice manager, cosmetic surgery center · Atlanta, GA</footer></article>
    </div>
  </div>
</section>
...
<div class="modal-overlay" id="bookModalOverlay" aria-hidden="true">
  <div class="modal" id="bookModal" role="dialog" aria-modal="true" aria-labelledby="bookModalTitle">
    ...
    <form class="form modal__form" id="leadForm" action="#" method="post" novalidate>
      <div class="modal__steps">
        <span class="modal__step-dot is-active" data-dot="1"></span>
        <span class="modal__step-dot" data-dot="2"></span>
      </div>
      <p class="modal__eyebrow" id="modalStepLabel">Step 1 of 2</p>

      <div class="modal__panel" data-panel="1">
        <h3 id="bookModalTitle">Get your free strategy call</h3>
        <p class="form__note">We'll respond within one business day.</p>
        <ul class="modal__trust">
          <li>No long-term contract</li>
          <li>60-day money-back guarantee</li>
          <li>15-minute call, no pressure</li>
        </ul>
        <label>Full name<input type="text" name="name" autocomplete="name"></label>
        <label>Practice name *<input type="text" name="practice" required></label>
        <div class="form__row">
        ...
        <button class="btn btn--signal btn--block btn--lg" type="button" id="modalNextBtn">Continue →</button>
      </div>

      <div class="modal__panel" data-panel="2" hidden>
        <h3>Almost there</h3>
        <p class="form__note">A couple quick details so Nathan can prep ideas for your market.</p>
        <div class="form__row">
          <label>Which state do you practice in?<input type="text" name="state"></label>
          <label>Interested package
            <select name="package"><option value="">Optional</option><option>Starter</option><option>Growth</option><option>Dominate</option><option>Not sure yet</option></select>
          </label>
        </div>
        <button class="btn btn--signal btn--block btn--lg" type="submit">Book My Free Strategy Call →</button>
        <button class="modal__back" type="button" id="modalBackBtn">← Back</button>
        <p class="form__legal">By submitting, you agree to be contacted by Apex Marketing about your inquiry.</p>
      </div>
    </form>
  </div>
